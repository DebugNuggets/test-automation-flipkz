...
public class NameConstants {
    ...
    public static final String WWW_FLIP_KZ = "https://www.flip.kz/";
    public static final String PROFILE_HOVER_ELEMENT = "//span[@class='p500']";
    public static final String EXAMPLE_PRODUCT_XPATH = "//a[@class='pic l-h-250']";
    public static final String ADD_PRODUCT_XPATH = "//input[@id='cart_button']";
    public static final String SUBMIT_XPATH = "//input[@name='order_button']";
    public static final String DEFAULT_SUBMIT_XPATH = "//button[@type='submit']";
    ...
    public static final String ENTRANCE = "5";
    public static final String FLOOR = "5";
