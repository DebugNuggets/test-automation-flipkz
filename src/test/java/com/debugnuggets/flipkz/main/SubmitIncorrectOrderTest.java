...
public class SubmitIncorrectOrderTest {
    ...
    public void submitOrderWithWrongCredentials() {
        ...
        addressFormPage.submitWrongAddress();

        test = extent
                .createTest("Test Case 5", "The test case 'submit order with wrong credentials' has passed");
    }
}
